...
async def batch_start_schedule(
    ...
    data = await schedule_service.batch_start(req.phones, req.chatIds, req.content, req.intervalMin, req.intervalSec)
    return result(data)
...
async def start_schedule(
    ...
    try:
        await schedule_service.start(phone, req.chatIds, req.content, req.intervalMin, req.intervalSec)
